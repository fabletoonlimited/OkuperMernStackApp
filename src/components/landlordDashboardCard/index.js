            ...
            <div className="landlordDashboardCard grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {profilePercent !== 100 && (
                    <div className="space-y-2 rounded-lg bg-white p-6 shadow-md">
                        ...
                        <p>
                            Add a profile picture to help guests know you better
                        </p>
                ...
                {profilePercent !== 100 && (
                    <div className="space-y-2 rounded-lg bg-white p-6 shadow-md">
                        ...
                        <p>
                            These preferences will help us match you better with
                            homes
                        </p>
                ...
                {profilePercent !== 100 && (
                    <div className="space-y-2 rounded-lg bg-white p-6 shadow-md">
                        ...
                        <p>
                            Add your account details so we can forward tenant
                            payments after finalizing a home
                        </p>
