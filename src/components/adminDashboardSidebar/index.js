...
const index = () => {
  ...
  return (
      <>
          ...
          {/* Sidebar */}
          <aside
              className={`landlordDashboardSidebar  text-white px-2 bg-blue-950 h-screen w-[272px] fixed top-0 left-0 z-50 transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
              <Link href={"/"}>
                  <img
