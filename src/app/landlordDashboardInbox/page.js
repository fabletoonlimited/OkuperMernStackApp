                              ...
                              {showProfile ? (
                                  <div className="p-8 border-t border-gray-200 bg-gray-50 flex flex-col items-center justify-center text-black">
                                      ...
                                      <p className="text-xl mb-2 text-center">
                                          ...
                                          <span className="font-light">
                                              {otherParticipant?.maritalStatus ||
                                                  "N/A"}
                                          </span>
                                      </p>
                                      ...
                                      {otherParticipant?.maritalStatus ===
                                          ...
                                          <>
                                              ...
                                              <p className="text-xl mb-2 text-center">
                                                  ...
                                                  <span className="font-light">
                                                      {otherParticipant?.numberOfChildren ||
                                                          "0"}
                                                  </span>
                                              </p>
                                          </>
                                      ...
                                      <p className="text-xl mb-2 text-center">
                                          ...
                                          <span className="font-light">
                                              {otherParticipant?.currentAddress ||
                                                  "N/A"}
                                          </span>
                                      </p>
