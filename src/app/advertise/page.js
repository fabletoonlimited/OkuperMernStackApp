            ...
            <div className={`flex flex-col md:flex-row ${styles.container}`}>
                <div className={`mt-8 ${styles.left}`}>
                    ...
                    <div className={`space-y-5 m-5 md:ml-32  ${styles.sample}`}>
                        ...
                        <div
                            className={`  md:w-[350px] md:h-[259px]  ml-6 ${styles.form}`}>
                    ...
                    <h4
                        className={` font-semibold  text-xl relative left-25 md:left-[204px] md:mt-18 ${styles.dim}`}>
                        Dimension: 350px by 259px
                    </h4>

                    <div>
                        <div
                            className={`space-y-5  mt-12 md:ml-32 mb-9 ${styles.banner}`}>
                            <h3 className="font-medium md:text-4xl text-2xl md:mr-10 ml-8 text-[rgba(14,29,72,1)] ">
                                Sample of side AD Banner.
                            </h3>

                            <div
                                className={` md:w-[350px] m-5 md:h-[870px] md:top-[942px] ${styles.brand}`}>
                ...
                <div
                    ...
                    <img
                        src="/bannerlady.png"
                        alt="bannerlady"
                        className={`absolute md:mt-15 mt-17 h-115 md:h-auto ${styles.bannerlady}`}
                    />
