            ...
            <div className= {`flex gap-16 ${styles.container}`}>
                <div className={`mt-20 ${styles.left}`}>
                    ...
                    <div className={`space-y-5 mt-5 ${styles.sample}`}>
                        ...
                        <div className={`align-center space-y-3 text-center p-10  border-2 rounded-lg bg-blue-900 mb-9 ml-30 text-white inline-block ${styles.card}`}>
                            <h4 className="font-semibold text-2xl">Product / Brand Name!</h4>
                            <p className="text-lg">Text and punchline you want to <br/>communicate with your customers,<br/>brand colour/image for your brand.</p>
                            <p className="text-center border border-white text-2xl  rounded-xl p-3 inline-block ">Your Link....</p>
                        </div>
                        <h4 className="text-center mr-18 font-semibold text-xl ">Dimension: 350px by 259px</h4>
                        ...
                        <div className={`space-y-5 p-10 mt-12 ${styles.banner}`}>          
                            ...
                            <div className={`align-center space-y-3 text-center p-14 pt-44 border-2 rounded-lg bg-blue-900 min-h-[900px] ml-20 text-white inline-block ${styles.brand}`}>
                            ...
                            <p className="text-lg font-medium">Text and punchline you want to <br/>
                                ...
                                <h4 className="font-semibold text-xl leading-relaxed text-center mr-10 text-[rgba(14,29,72,1)]">Dimension: 350px by 870px
                    ...
                    <div className={` text-white  mt-38 ${styles.text}`}>
                        ...
                        <p className=" absolute font-medium leading-relaxed text-2xl   pl-14">Showcase your  brand to the hundreds of <br/> user who interact with our platform daily.<br/>
                            Join us as we the real estate industry and <br/> give the power back to the people. 
                        </p>
                        <img 
                            src="/bannerlady.png" 
                            alt="bannerlady" 
