...
const page = () => {
  return (
    <>
        <h1 className='font-bold text-4xl' style={{paddingLeft: 45, marginTop: 70}}>Signup as Tenant</h1>
        ...
        <div className='signUpLoandingContainer md:flex-col col mt-10 mb-50'>
            ...
            >
                    ...
                    <p style={{paddingTop: 20, marginBottom: 30}}>How did you hear about Okuper</p>
                    <input 
                        type="text" 
            ...
            <div className="tenantSignUpBtn mt-10 ml-12 md:ml-12 flex flex-col md:flex-row gap-5">
                <Link href='/signInTenant'>
                    <button 
                    className='tenantSignUpBtn bg-blue-950 hover:bg-blue-800 text-white p-4 md:w-140 w-75 border-1px text-2xl text-center cursor-pointer md:mb-20 mb-30'> Sign Up </button>
                </Link>
            </div>
